...
public class WebhookService implements WebhookInputPort {
	...
	public WebhookService(IWebhookRepository IWebhookRepository, PedidoInputPort pedidoInputPort, Logger log) {
