package br.com.postechfiap.jlapp.cliente.domain.entities;
...
public class Cliente {
	...
	public Cliente toCliente(ClienteRequestModel clienteRequestModel) {
		this.id = clienteRequestModel.getId();
		this.nome = clienteRequestModel.getNome();
		this.cpf = clienteRequestModel.getCpf();
		this.email = clienteRequestModel.getEmail();
		return this;
	}
