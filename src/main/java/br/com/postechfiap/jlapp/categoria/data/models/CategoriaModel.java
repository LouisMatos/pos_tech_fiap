...
public class CategoriaModel implements Serializable {
	...
	private List<ProdutoModel> produtoEntities = new ArrayList<>();


	public Categoria toCategoria(CategoriaModel categoriaModel) {
		return new Categoria(categoriaModel.getId(), categoriaModel.getNome(), categoriaModel.getDescricao(), new ArrayList<>());
	}
